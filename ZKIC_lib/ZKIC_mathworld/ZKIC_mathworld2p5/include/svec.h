...
namespace details
{
	...
	template <> struct Sparse_Eps_Type_Selector<ZK::bin> {typedef int eps_type;};
}
...
Sparse_Vec<T>::Sparse_Vec(const Vec<T> &v)
{
  ...
  v_size = v.size();
  used_size = 0;
  data_size = std::min(v.size(), static_cast<size_t>(10000));
  alloc();
...
{
  ZKIC_Assert(new_size >= used_size, "Sparse_Vec<T>::resize_data(int new_size): New size is to small");
...
{
  ZKIC_Assert(i >= 0 && i < v_size, "The index of the element is out of range");
...
{
  ZKIC_Assert(v_size > i, "The index of the element exceeds the size of the sparse vector");
...
void Sparse_Vec<T>::add(const ivec& index_vec, const Vec<T>& v)
{
  ...
  ZKIC_Assert(v_size > max(index_vec), "The indices exceeds the size of the sparse vector");
...
{
  ZKIC_Assert(v_size > i1 && v_size > i2 && i1 <= i2 && i1 >= 0, "The index of the element exceeds the size of the sparse vector");
...
void Sparse_Vec<T>::operator+=(const Sparse_Vec<T> &v)
{
  ...
  ZKIC_Assert(v_size == v.size(), "Attempted addition of unequal sized sparse vectors");
...
void Sparse_Vec<T>::operator-=(const Sparse_Vec<T> &v)
{
  ...
  ZKIC_Assert(v_size == v.size(), "Attempted subtraction of unequal sized sparse vectors");
...
T operator*(const Sparse_Vec<T> &v1, const Sparse_Vec<T> &v2)
{
  ZKIC_Assert(v1.v_size == v2.v_size, "Sparse_Vec<T> * Sparse_Vec<T>");
...
T operator*(const Sparse_Vec<T> &v1, const Vec<T> &v2)
{
  ZKIC_Assert(v1.size() == v2.size(), "Multiplication of unequal sized vectors attempted");
...
Sparse_Vec<T> elem_mult(const Sparse_Vec<T> &v1, const Sparse_Vec<T> &v2)
{
  ZKIC_Assert(v1.v_size == v2.v_size, "elem_mult(Sparse_Vec<T>, Sparse_Vec<T>)");
...
Vec<T> elem_mult(const Sparse_Vec<T> &v1, const Vec<T> &v2)
{
  ZKIC_Assert(v1.v_size == v2.size(), "elem_mult(Sparse_Vec<T>, Vec<T>)");
...
Vec<T> elem_mult(const Vec<T> &v1, const Sparse_Vec<T> &v2)
{
  ZKIC_Assert(v1.size() == v2.v_size, "elem_mult(Vec<T>, Sparse_Vec<T>)");
...
ZKIC_DLL_EXPORT_TEMPLATE template class ZKIC_DLL_EXPORT Sparse_Vec<int>;
ZKIC_DLL_EXPORT_TEMPLATE template class ZKIC_DLL_EXPORT Sparse_Vec<double>;
ZKIC_DLL_EXPORT_TEMPLATE template class ZKIC_DLL_EXPORT Sparse_Vec<std::complex<double> >;

ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT sparse_ivec operator+(const sparse_ivec &,
                                        const sparse_ivec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT sparse_vec operator+(const sparse_vec &,
                                       const sparse_vec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT sparse_cvec operator+(const sparse_cvec &,
                                        const sparse_cvec &);

ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT int operator*(const sparse_ivec &, const sparse_ivec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT double operator*(const sparse_vec &, const sparse_vec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT std::complex<double> operator*(const sparse_cvec &,
    const sparse_cvec &);

ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT int operator*(const sparse_ivec &, const ivec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT double operator*(const sparse_vec &, const vec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT std::complex<double> operator*(const sparse_cvec &,
    const cvec &);

ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT int operator*(const ivec &, const sparse_ivec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT double operator*(const vec &, const sparse_vec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT std::complex<double> operator*(const cvec &,
    const sparse_cvec &);

ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT sparse_ivec elem_mult(const sparse_ivec &,
                                        const sparse_ivec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT sparse_vec elem_mult(const sparse_vec &, const sparse_vec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT sparse_cvec elem_mult(const sparse_cvec &,
                                        const sparse_cvec &);

ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT ivec elem_mult(const sparse_ivec &, const ivec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT vec elem_mult(const sparse_vec &, const vec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT cvec elem_mult(const sparse_cvec &, const cvec &);

ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT sparse_ivec elem_mult_s(const sparse_ivec &, const ivec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT sparse_vec elem_mult_s(const sparse_vec &, const vec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT sparse_cvec elem_mult_s(const sparse_cvec &, const cvec &);

ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT ivec elem_mult(const ivec &, const sparse_ivec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT vec elem_mult(const vec &, const sparse_vec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT cvec elem_mult(const cvec &, const sparse_cvec &);

ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT sparse_ivec elem_mult_s(const ivec &, const sparse_ivec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT sparse_vec elem_mult_s(const vec &, const sparse_vec &);
ZKIC_DLL_EXPORT_TEMPLATE template ZKIC_DLL_EXPORT sparse_cvec elem_mult_s(const cvec &, const sparse_cvec &);
