...
*/
ZKIC_DLL_EXPORT vec operator+(const double &s, const ivec &v);
...
*/
ZKIC_DLL_EXPORT vec operator/(const ivec &v, const double &s);

/*!
  \relatesalso Vec
  \brief Addition operator for complex<double> and ivec
*/
ZKIC_DLL_EXPORT cvec operator+(const std::complex<double> &s, const ivec &v);
...
*/
ZKIC_DLL_EXPORT cvec operator/(const ivec &v, const std::complex<double> &s);
...
*/
ZKIC_DLL_EXPORT cvec operator+(const double &s, const cvec &v);
...
*/
ZKIC_DLL_EXPORT cvec operator/(const cvec &v, const double &s);
...
*/
ZKIC_DLL_EXPORT cmat operator+(const double &s, const cmat &m);
...
*/
ZKIC_DLL_EXPORT cmat operator*(const std::complex<double> &s, const mat &m);
...
*/
ZKIC_DLL_EXPORT cmat operator/(const cmat &m, const double &s);
...
*/
ZKIC_DLL_EXPORT vec operator+(const bvec &a, const vec &b);

/*!
  \relatesalso Vec
  \brief Addition operator for svec and vec
*/
ZKIC_DLL_EXPORT vec operator+(const svec &a, const vec &b);

/*!
  \relatesalso Vec
  \brief Addition operator for ivec and vec
*/
ZKIC_DLL_EXPORT vec operator+(const ivec &a, const vec &b);
...
*/
ZKIC_DLL_EXPORT double operator*(const bvec &a, const vec &b);

/*!
  \relatesalso Vec
  \brief Multiplication operator for svec and vec
*/
ZKIC_DLL_EXPORT double operator*(const svec &a, const vec &b);

/*!
  \relatesalso Vec
  \brief Multiplication operator for ivec and vec
*/
ZKIC_DLL_EXPORT double operator*(const ivec &a, const vec &b);
...
*/
ZKIC_DLL_EXPORT cvec operator+(const bvec &a, const cvec &b);

/*!
  \relatesalso Vec
  \brief Addition operator for svec and cvec
*/
ZKIC_DLL_EXPORT cvec operator+(const svec &a, const cvec &b);

/*!
  \relatesalso Vec
  \brief Addition operator for ivec and cvec
*/
ZKIC_DLL_EXPORT cvec operator+(const ivec &a, const cvec &b);
...
*/
ZKIC_DLL_EXPORT std::complex<double> operator*(const bvec &a, const cvec &b);

/*!
  \relatesalso Vec
  \brief Multiplication operator for svec and cvec
*/
ZKIC_DLL_EXPORT std::complex<double> operator*(const svec &a, const cvec &b);

/*!
  \relatesalso Vec
  \brief Multiplication operator for ivec and cvec
*/
ZKIC_DLL_EXPORT std::complex<double> operator*(const ivec &a, const cvec &b);
...
*/
ZKIC_DLL_EXPORT mat operator+(const bmat &a, const mat &b);

/*!
  \relatesalso Mat
  \brief Addition operator for smat and mat
*/
ZKIC_DLL_EXPORT mat operator+(const smat &a, const mat &b);

/*!
  \relatesalso Mat
  \brief Addition operator for imat and mat
*/
ZKIC_DLL_EXPORT mat operator+(const imat &a, const mat &b);
...
*/
ZKIC_DLL_EXPORT cmat operator+(const bmat &a, const cmat &b);

/*!
  \relatesalso Mat
  \brief Addition operator for smat and cmat
*/
ZKIC_DLL_EXPORT cmat operator+(const smat &a, const cmat &b);

/*!
  \relatesalso Mat
  \brief Addition operator for imat and cmat
*/
ZKIC_DLL_EXPORT cmat operator+(const imat &a, const cmat &b);

/*!
  \relatesalso Mat
  \brief Addition operator for mat and cmat
*/
ZKIC_DLL_EXPORT cmat operator+(const mat &a, const cmat &b);
