...
ZKIC_DLL_EXPORT void GlobalRNG_reset(unsigned int seed);

//! Reset the internal seed of the Global Seed Provider to the previously set value
ZKIC_DLL_EXPORT void GlobalRNG_reset();

//! Get new seed to initialize thread-local generators
ZKIC_DLL_EXPORT unsigned int GlobalRNG_get_local_seed();

//! Set a random seed for the Global Seed Provider seed
ZKIC_DLL_EXPORT void GlobalRNG_randomize();

//! Save current full state of global seed provider in memory
ZKIC_DLL_EXPORT void GlobalRNG_get_state(ivec &state);

//! Resume the global seed provider state saved in memory
ZKIC_DLL_EXPORT void GlobalRNG_set_state(const ivec &state);
...
ZKIC_DLL_EXPORT void RNG_reset(unsigned int seed);
 ...
 * \sa DSFMT
 */
class ZKIC_DLL_EXPORT Random_Generator
{
...
/*!
  ...
  \ingroup randgen
*/
class ZKIC_DLL_EXPORT Bernoulli_RNG
{
public:
  ...
  void setup(double prob) {
    ZKIC_Assert(prob >= 0.0 && prob <= 1.0, "The Bernoulli source probability "
...
/*!
  ...
  \endcode
*/
class ZKIC_DLL_EXPORT I_Uniform_RNG
{
public:
...
/*!
  ...
  \ingroup randgen
*/
class ZKIC_DLL_EXPORT Uniform_RNG
{
public:
...
/*!
  ...
  \ingroup randgen
*/
class ZKIC_DLL_EXPORT Exponential_RNG
{
public:
 ...
 */
class ZKIC_DLL_EXPORT Normal_RNG
{
public:
 ...
 * \author Vasek Smidl
 */
class ZKIC_DLL_EXPORT Gamma_RNG
{
public:
...
/*!
  ...
  \ingroup randgen
*/
class ZKIC_DLL_EXPORT Laplace_RNG
{
public:
  //! Constructor. Set mean and variance.
...
/*!
  ...
  \ingroup randgen
*/
class ZKIC_DLL_EXPORT Complex_Normal_RNG
{
public:
  //! Constructor. Set mean and variance.
...
/*!
  ...
  \ingroup randgen
*/
class ZKIC_DLL_EXPORT AR1_Normal_RNG
{
public:
...
/*!
  ...
  \ingroup randgen
*/
class ZKIC_DLL_EXPORT Weibull_RNG
{
public:
...
/*!
  ...
  \ingroup randgen
*/
class ZKIC_DLL_EXPORT Rayleigh_RNG
{
public:
...
/*!
  ...
  \ingroup randgen
*/
class ZKIC_DLL_EXPORT Rice_RNG
{
public:
