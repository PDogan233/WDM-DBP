 ...
 */
ZKIC_DLL_EXPORT bool svd(const mat &A, vec &s);
 ...
 * \note An external LAPACK library is required by this function.
 */
ZKIC_DLL_EXPORT bool svd(const cmat &A, vec &s);
...
/*!
   ...
   * \note An external LAPACK library is required by this function.
   */
ZKIC_DLL_EXPORT vec svd(const mat &A);
 ...
 * \note An external LAPACK library is required by this function.
 */
ZKIC_DLL_EXPORT vec svd(const cmat &A);
 ...
 * \note An external LAPACK library is required by this function.
 */
ZKIC_DLL_EXPORT bool svd(const mat &A, mat &U, vec &s, mat &V);
 ...
 * \note An external LAPACK library is required by this function.
 */
ZKIC_DLL_EXPORT bool svd(const cmat &A, cmat &U, vec &s, cmat &V);
