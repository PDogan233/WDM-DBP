...
*/
class ZKIC_DLL_EXPORT CPU_Timer : public Timer
{
public:
  //! Create a new timer. Sets the time to zero.
  CPU_Timer() { }
...
/*!
  ...
  \warning May give an negative answer if the measured time is too long.
*/
class ZKIC_DLL_EXPORT Real_Timer : public Timer
{
public:
  //! Create a new timer. Sets the time to zero.
  Real_Timer() { }
...
*/
ZKIC_DLL_EXPORT void pause(double t = -1);
