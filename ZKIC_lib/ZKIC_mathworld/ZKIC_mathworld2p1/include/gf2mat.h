...
template class ZKIC_DLL_IMPORT Sparse_Mat<bin>;
template class ZKIC_DLL_IMPORT Sparse_Vec<bin>;
template class ZKIC_DLL_IMPORT Mat<unsigned char>;
...
*/
class ZKIC_DLL_EXPORT GF2mat_sparse_alist
{
public:
  //! Default constructor
...
public:
  ...
  */
  ...
  friend ZKIC_DLL_EXPORT GF2mat operator*(const GF2mat &X, const GF2mat &Y);

  //! Multiplication operator with binary vector
  friend ZKIC_DLL_EXPORT bvec operator*(const GF2mat &X, const bvec &y);
  ...
  friend ZKIC_DLL_EXPORT std::ostream &operator<<(std::ostream &os, const GF2mat &X);

  //! Write the matrix to file
  friend ZKIC_DLL_EXPORT it_file &operator<<(it_file &f, const GF2mat &X);

  //! Read the matrix from file
  friend ZKIC_DLL_EXPORT it_ifile &operator>>(it_ifile &f, GF2mat &X);

  //!Multiplication X*Y' where X and Y are GF(2) matrices
  friend ZKIC_DLL_EXPORT GF2mat mult_trans(const GF2mat &X, const GF2mat &Y);
...
*/
ZKIC_DLL_EXPORT it_file &operator<<(it_file &f, const GF2mat &X);

/*!
  /relatesalso GF2mat
  /brief Read GF(2) matrix from file.
*/
ZKIC_DLL_EXPORT it_ifile &operator>>(it_ifile &f, GF2mat &X);
...
*/
ZKIC_DLL_EXPORT GF2mat operator*(const GF2mat &X, const GF2mat &Y);

/*!
  \relatesalso GF2mat
  \brief GF(2) matrix multiplication with "regular" binary vector
*/
ZKIC_DLL_EXPORT bvec operator*(const GF2mat &X, const bvec &y);
...
*/
ZKIC_DLL_EXPORT std::ostream &operator<<(std::ostream &os, const GF2mat &X);

/*!
  \relatesalso GF2mat
  \brief GF(2) Identity matrix
*/
ZKIC_DLL_EXPORT GF2mat gf2dense_eye(int m);

/*!
  \relatesalso GF2mat
  \brief Multiplication X*Y' where X and Y are GF(2) matrices
*/
ZKIC_DLL_EXPORT GF2mat mult_trans(const GF2mat &X, const GF2mat &Y);
...
{
  ZKIC_Assert(i >= 0 && i < nrows, "GF2mat::addto_element()");
  ZKIC_Assert(j >= 0 && j < ncols, "GF2mat::addto_element()");
  if (s == 1)
...
{
  ZKIC_Assert(i >= 0 && i < nrows, "GF2mat::get_element()");
  ZKIC_Assert(j >= 0 && j < ncols, "GF2mat::get_element()");
  return (data(i, (j >> shift_divisor)) >> (j & rem_mask)) & 1;
}

inline void GF2mat::set(int i, int j, bin s)
{
  ZKIC_Assert(i >= 0 && i < nrows, "GF2mat::set_element()");
  ZKIC_Assert(j >= 0 && j < ncols, "GF2mat::set_element()");
