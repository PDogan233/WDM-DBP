...
template<>
ZKIC_DLL_EXPORT bool Parser::get(std::string &var, const std::string &name, int num);
//! Specialization of \c get() for int
template<>
ZKIC_DLL_EXPORT bool Parser::get(int &var, const std::string &name, int num);
//! Specialization of \c get() for bool
template<>
ZKIC_DLL_EXPORT bool Parser::get(bool &var, const std::string &name, int num);
