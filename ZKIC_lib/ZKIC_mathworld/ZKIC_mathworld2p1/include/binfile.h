...
*/
class ZKIC_DLL_EXPORT bfstream_base
{
public:
  /*!
...
/*!
  ...
  facilities.
*/
  class ZKIC_DLL_EXPORT Ofstream_Binfile_Facade
  {
    std::ofstream* _str;
...
/*!
  ...
  facilities.
*/
  class ZKIC_DLL_EXPORT Ifstream_Binfile_Facade
  {
    std::ifstream* _str;
    //following makes class non-copiable
...
*/
  class ZKIC_DLL_EXPORT Fstream_Binfile_Facade
  {
    std::fstream* _str;
    //following makes class non-copiable
...
/*!
  ...
  \ingroup itfile
*/
class ZKIC_DLL_EXPORT bofstream : public bfstream_base, public binfile_details::Ofstream_Binfile_Facade
{
public:
  /*!
...
/*!
  ...
  \ingroup itfile
*/
class ZKIC_DLL_EXPORT bifstream : public bfstream_base, public binfile_details::Ifstream_Binfile_Facade
{
public:
  /*!
    \brief Class constructor that opens a file and sets the endianity
...
/*!
  ...
  \ingroup itfile
*/
class ZKIC_DLL_EXPORT bfstream : public bfstream_base, public binfile_details::Fstream_Binfile_Facade
{
public:
  /*!
    \brief Class constructor that opens a file and sets the endianity
