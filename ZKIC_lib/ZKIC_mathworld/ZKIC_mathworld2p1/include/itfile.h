...
/*!
  ...
  \ingroup itfile
*/
class ZKIC_DLL_EXPORT it_file_base
{
public:
...
/*!
  ...
  \ingroup itfile
*/
class ZKIC_DLL_EXPORT it_ifile : public it_file_base
{
public:
  //! Default constructor
  it_ifile();
...
/*!
  ...
  \ingroup itfile
*/
class ZKIC_DLL_EXPORT it_file : public it_ifile
{
public:
...
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, char& v);
//! Read the bool variable \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile &f, bool &v);

//! Read the binary variable \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, bin& v);
//! Read the short variable \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, short& v);
//! Read the integer variable \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, int& v);
//! Read the float variable \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, float& v);
//! Read the double variable \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, double& v);
//! Read the float complex variable \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, std::complex<float>& v);
//! Read the double complex variable \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, std::complex<double>& v);

//! Read the bvec \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, bvec& v);
//! Read the svec \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, svec& v);
//! Read the ivec \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, ivec& v);
//! Read the vec \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, vec& v);
//! Read the cvec \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, cvec& v);

//! Read the string \c str from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, std::string& str);

//! Read the bmat \c m from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, bmat& m);
//! Read the smat \c m from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, smat& m);
//! Read the imat \c m from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, imat& m);
//! Read the mat \c m from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, mat& m);
//! Read the cmat \c m from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, cmat& m);

//! Read the binary Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<bin>& v);
//! Read the short integer Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<short>& v);
//! Read the integer Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<int>& v);
//! Read the float Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<float>& v);
//! Read the double Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<double>& v);
//! Read the float complex Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<std::complex<float> >& v);
//! Read the double complex Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<std::complex<double> >& v);

//! Read the bvec Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<bvec>& v);
//! Read the svec Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<svec>& v);
//! Read the ivec Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<ivec>& v);
//! Read the vec Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<vec>& v);
//! Read the cvec Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<cvec>& v);

//! Read the string Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<std::string>& v);

//! Read the bmat Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<bmat>& v);
//! Read the bmat Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<smat>& v);
//! Read the imat Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<imat>& v);
//! Read the mat Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<mat>& v);
//! Read the cmat Array \c v from the \c it_ifile pointer
ZKIC_DLL_EXPORT it_ifile& operator>>(it_ifile& f, Array<cmat>& v);


//! Write the char variable \c x to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, char x);
//! Write the bool variable \c x to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file &f, bool x);

//! Write the binary variable \c x to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, bin x);
//! Write the short variable \c x to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, short x);
//! Write the integer variable \c x to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, int x);
//! Write the float variable \c x to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, float x);
//! Write the double variable \c x to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, double x);
//! Write the float complex variable \c x to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, std::complex<float> x);
//! Write the double complex variable \c x to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, std::complex<double> x);

//! Write the bvec \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const bvec& v);
//! Write the svec \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const svec& v);
//! Write the ivec \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const ivec& v);
//! Write the vec \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const vec& v);
//! Write the cvec \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const cvec& v);

//! Write the string \c str to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const std::string& str);

//! Write the bmat \c m to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const bmat& m);
//! Write the smat \c m to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const smat& m);
//! Write the imat \c m to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const imat& m);
//! Write the mat \c m to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const mat& m);
//! Write the cmat \c m to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const cmat& m);

//! Write the bin Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<bin>& v);
//! Write the short int Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<short>& v);
//! Write the int Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<int>& v);
//! Write the float Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<float>& v);
//! Write the double Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<double>& v);
//! Write the float complex Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<std::complex<float> >& v);
//! Write the double complex Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<std::complex<double> >& v);

//! Write the bvec Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<bvec>& v);
//! Write the svec Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<svec>& v);
//! Write the ivec Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<ivec>& v);
//! Write the vec Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<vec>& v);
//! Write the cvec Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<cvec>& v);

//! Write the string Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<std::string>& v);

//! Write the bmat Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<bmat>& v);
//! Write the smat Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<smat>& v);
//! Write the imat Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<imat>& v);
//! Write the mat Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<mat>& v);
//! Write the cmat Array \c v to the \c it_file pointer
ZKIC_DLL_EXPORT it_file& operator<<(it_file& f, const Array<cmat>& v);
...
/*!
  ...
  \ingroup itfile
*/
class ZKIC_DLL_EXPORT it_file_base_old
{
public:
...
/*!
  ...
  \ingroup itfile
*/
class ZKIC_DLL_EXPORT it_ifile_old : public it_file_base_old
{
public:
  //!Constructor.
  it_ifile_old();
...
/*!
  ...
  \ingroup itfile
*/
class ZKIC_DLL_EXPORT it_file_old : public it_ifile_old
{
public:
  //! ACTION: Add documentation for this typedef
...
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, char& v);

//!Read the binary variable \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, bin& v);

//!Read the short variable \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, short& v);

//!Read the integer variable \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, int& v);

//!Read the float variable \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, float& v);

//!Read the double variable \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, double& v);

//!Read the float complex variable \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, std::complex<float>& v);

//!Read the double complex variable \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, std::complex<double>& v);

//!Read the vec \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, vec& v);

//!Read the ivec \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, ivec& v);

//!Read the bvec \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, bvec& v);

//!Read the cvec \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, cvec& v);

//!Read the string \c str from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, std::string& str);

//!Read the mat \c m from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, mat& m);

//!Read the imat \c m from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, imat& m);

//!Read the bmat \c m from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, bmat& m);

//!Read the cmat \c m from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, cmat& m);

//!Read the float Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<float>& v);

//!Read the double Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<double>& v);

//!Read the integer Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<int>& v);

//!Read the binary Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<bin>& v);

//!Read the float complex Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<std::complex<float> >& v);

//!Read the double complex Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<std::complex<double> >& v);

//!Read the vec Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<vec>& v);

//!Read the ivec Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<ivec>& v);

//!Read the bvec Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<bvec>& v);

//!Read the cvec Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<cvec>& v);

//!Read the string Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<std::string>& v);

//!Read the mat Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<mat>& v);

//!Read the imat Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<imat>& v);

//!Read the bmat Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<bmat>& v);

//!Read the cmat Array \c v from the \c it_ifile_old pointer
ZKIC_DLL_EXPORT it_ifile_old& operator>>(it_ifile_old& f, Array<cmat>& v);


//!Write the char variable \c x to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, char x);

//!Write the binary variable \c x to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, bin x);

//!Write the short variable \c x to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, short x);

//!Write the integer variable \c x to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, int x);

//!Write the float variable \c x to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, float x);

//!Write the double variable \c x to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, double x);

//!Write the float complex variable \c x to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, std::complex<float> x);

//!Write the double complex variable \c x to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, std::complex<double> x);

//!Write the vec \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const vec& v);

//!Write the ivec \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const ivec& v);

//!Write the bvec \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const bvec& v);

//!Write the cvec \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const cvec& v);

//!Write the string \c str to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const std::string& str);

//!Write the mat \c m to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const mat& m);

//!Write the imat \c m to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const imat& m);

//!Write the bmat \c m to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const bmat& m);

//!Write the cmat \c m to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const cmat& m);

//!Write the float Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<float>& v);

//!Write the double Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<double>& v);

//!Write the int Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<int>& v);

//!Write the bin Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<bin>& v);

//!Write the float complex Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<std::complex<float> >& v);

//!Write the double complex Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<std::complex<double> >& v);

//!Write the vec Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<vec>& v);

//!Write the ivec Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<ivec>& v);

//!Write the bvec Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<bvec>& v);

//!Write the cvec Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<cvec>& v);

//!Write the string Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<std::string>& v);

//!Write the mat Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<mat>& v);

//!Write the imat Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<imat>& v);

//!Write the bmat Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<bmat>& v);

//!Write the cmat Array \c v to the \c it_file_old pointer
ZKIC_DLL_EXPORT it_file_old& operator<<(it_file_old& f, const Array<cmat>& v);
