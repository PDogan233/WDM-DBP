...
%
% Usage:
%   1. Build & run ZKIC_project.exe (generates .dat files)
%   2. >> DP_DBPTest
%
...
%% ============================================================
%% Part A: Fiber Propagation (signal -> fiber -> distorted)
%% ============================================================

fprintf('=== Part A: Fiber Propagation Visualization ===\n');
allPass = true;
...
%   For full verification, see Part A of this script to confirm DBP
...
fprintf('  See Part A of this script for DBP compensation verification.\n');
...
%% ============================================================
%% Part B: DBP Compensation (fiber output -> DBP -> recovered)
%% ============================================================

fprintf('=== Part B: DBP Round-Trip Visualization ===\n');
